...
public class prac_9 {
	...
	public static void main(String[] args) throws Exception {
		...
		// drag and drop
				...
				Thread.sleep(2000);
				act.contextClick(selenium).build().perform();
				
				  WebElement agile_project = driver.findElement(By.xpath("//a[text()='Agile Project']"));
				  Thread.sleep(2000);
				 act.doubleClick(agile_project).build().perform();
